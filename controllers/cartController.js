...
exports.updateQuantity = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Product quantity updated successfully.', cart, totalPrice });
    } catch (error) {
...
exports.removeItem = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Product removed from cart successfully.', cart, totalPrice });
    } catch (error) {
